...
namespace Valve.VR.InteractionSystem
{
    ...
    public class FloatingBlockInteraction : MonoBehaviour
    {
        [EnumFlags]
        ...
        public bool negateGravity = false;
        ...
        private void FixedUpdate()
        {
            if (negateGravity)
            {
                ...
                rend.material.SetColor("_Color", Color.Lerp(rend.material.color, Color.clear, Time.deltaTime));
            }
        }
